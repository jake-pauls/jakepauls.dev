            ...
            <Flex
                ...
                <SimpleGrid columns={{ base: 1, lg: 2 }}>
                    <Box pb={{ base: 0, lg: 16 }}>
                        ...
                        game engines, and graphics. Currently, I'm an undergraduate student
                        at BCIT finishing a {bcitProgramLink} with an expected graduation date of
                        <b> Spring 2023</b>.<br /><br />
                        While I finish my degree, I'm making games, exploring graphics APIs, and building
                        an app for Vancouver non-profit {ptLink}. Not to mention, I'm also building as much
                        as possible with C, C++, and C#. Recently, I've become a
                        bit of a Linux ({archLink}) and vim ({neovimLink}) fanatic, so you'll often find my {dotfilesLink} repo is
                        up to date. 😉<br /><br />
                        </Text>
                    </Box>
                    <AboutImage />
